...
As mentioned in Section 3.3 Spatial Patterns, a few sub-districts with significant changes are: Ciganjur, \_\_ and \_\_. Out of curiousity, I will be performing a temporal trend analysis on Ciganjur. For the remaining 2 sub-districts, I will be using the top 2 emerging sub-districts, where their p-values are the highest.
...
ggplot(data = drsw, 
  ...
  geom_line() +
  theme_light() +
  ggtitle("Duren Sawit Temporal Trend")
```
